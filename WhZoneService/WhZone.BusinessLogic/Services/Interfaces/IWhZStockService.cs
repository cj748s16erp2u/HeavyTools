...
public interface IWhZStockService : ILogicService<OlcWhzstock>
{
    /// <summary>
    /// Feldolgozási folyamat kontextus létrehozása
    /// </summary>
    /// <returns>A létrehozott kontextus</returns>
    IWhZStockContext CreateContext();
    ...
    ValueTask<OlcWhzstock?> GetAsync(IWhZStockKey key, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="OperationCanceledException">If the <see cref="CancellationToken" /> is canceled.</exception>
    ValueTask<IWhZStockData> AddReceivingAsync(IWhZStockContext context, WhZStockDto request, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <returns>A feldolgozott kérés adattartalma</returns>
    /// <exception cref="OperationCanceledException">If the <see cref="CancellationToken" /> is canceled.</exception>
    ValueTask<IWhZStockData> RemoveReceivingAsync(IWhZStockContext context, WhZStockDto request, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <returns>A feldolgozott kérés adattartalma</returns>
    /// <exception cref="OperationCanceledException">If the <see cref="CancellationToken" /> is canceled.</exception>
    ValueTask<IWhZStockData> CommitReceivingAsync(IWhZStockContext context, WhZStockDto request, CancellationToken cancellationToken = default);
    ...
    /// <returns>A feldolgozott kérés adattartalma</returns>
    /// <exception cref="OperationCanceledException">If the <see cref="CancellationToken" /> is canceled.</exception>
    ValueTask<IWhZStockData> AddReservedAsync(IWhZStockContext context, WhZStockDto request, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <returns>A feldolgozott kérés adattartalma</returns>
    /// <exception cref="OperationCanceledException">If the <see cref="CancellationToken" /> is canceled.</exception>
    ValueTask<IWhZStockData> RemoveReservedAsync(IWhZStockContext context, WhZStockDto request, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <returns>A feldolgozott kérés adattartalma</returns>
    /// <exception cref="OperationCanceledException">If the <see cref="CancellationToken" /> is canceled.</exception>
    ValueTask<IWhZStockData> CommitReservedAsync(IWhZStockContext context, WhZStockDto request, CancellationToken cancellationToken = default);
    ...
    void Delete(IWhZStockContext context, IWhZStockData request);
    ...
    /// <param name="context">Feldolgozási folyamat kontextus</param>
    /// <param name="cancellationToken">A <see cref="CancellationToken" /> to observe while waiting for the task to complete.</param>
    Task StoreAsync(IWhZStockContext context, CancellationToken cancellationToken = default);
}
