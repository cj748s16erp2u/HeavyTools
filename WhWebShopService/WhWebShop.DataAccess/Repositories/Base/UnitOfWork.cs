...
public class UnitOfWork : IDisposable, IUnitOfWork
{
    ...
    /// </summary>
    private readonly Stack<WhWebShopDbContext.Transaction> transactions = new Stack<WhWebShopDbContext.Transaction>();
    ...
    public UnitOfWork(WhWebShopDbContext dbContext)
    {
    ...
    public async Task<WhWebShopDbContext.Transaction> BeginTransactionAsync(CancellationToken cancellationToken = default)
    {
