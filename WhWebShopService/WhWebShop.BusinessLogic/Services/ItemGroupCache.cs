...
[RegisterDI(Interface = typeof(IItemGroupCache))]
public class ItemGroupCache : LogicServiceBase<OlsItemgroup>, IItemGroupCache
{
    public static ConcurrentDictionary<string, OlsItemgroup> cacheItemGroup = new ConcurrentDictionary<string, OlsItemgroup>();


    public ItemGroupCache(IValidator<OlsItemgroup> validator,
