 -- new fields: olc_action.discountcalculationtype
/*
exec sp_insertcolumn
  @tablename     = 'olc_actionext',
  @columndef     = 'discountcalculationtype int null',
...
go
if not exists(select 0 from sys.columns where object_id = object_id('olc_actionext') and name = 'discountcalculationtype')    alter table olc_actionext add discountcalculationtype int null
go
