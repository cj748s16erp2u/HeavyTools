-- new fields: olc_action.blockmessage
/*
exec sp_insertcolumn
  @tablename     = 'olc_action',
  @columndef     = 'blockmessage varchar(200) null',
...
go
if not exists(select 0 from sys.columns where object_id = object_id('olc_action') and name = 'blockmessage')    alter table olc_action add blockmessage varchar(200) null
go
