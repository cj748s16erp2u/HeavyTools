-- new fields: olc_action.isactive
/*
exec sp_insertcolumn
  @tablename     = 'olc_action',
  @columndef     = 'isactive int null',
  @refcolumnname = 'name',
  @after         = 0,
  @customsql     = '',
  @showonly      = 1
...
go
if not exists(select 0 from sys.columns where object_id = object_id('olc_action') and name = 'isactive')    alter table olc_action add isactive int null
go
