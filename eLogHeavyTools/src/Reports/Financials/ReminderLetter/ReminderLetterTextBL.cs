...
{
    public class ReminderLetterTextBL : Common.xcval.OfcXcvalBL<ReminderLetterText, ReminderLetterTextRules>
    {
        public static readonly string ID = typeof(ReminderLetterTextBL).FullName;

        public static T New<T>()
            where T : ReminderLetterTextBL
        {
            return ObjectFactory.New<T>();
        }

        public static ReminderLetterTextBL New()
        {
            return New<ReminderLetterTextBL>();
        }

        public ReminderLetterTextBL() : base(DefaultBLFunctions.Basic)
        {
        }
...
";
        ...
        public override bool IsDeletePossible(Key k, out string reason)
        {
            ...
            if (b)
            {
                ...
                {
                    reason = "$err_reminderlettertext_isused".eLogTransl();
                }
            }
