...
{
    public class StatementOfAccountTextSearchProvider : DefaultSearchProvider
    {
        public static readonly string ID = typeof(StatementOfAccountTextSearchProvider).FullName;
...
";
        ...
        protected StatementOfAccountTextSearchProvider() : base(queryString, argsTemplate, SearchProviderType.Default)
        {
        ...
        protected override void PreSearch(Dictionary<string, object> args)
        {
            ...
            args["xcvcode"] = StatementOfAccountBL.STATEMENTOFACCOUNT_TEXT_XCVCODE;
